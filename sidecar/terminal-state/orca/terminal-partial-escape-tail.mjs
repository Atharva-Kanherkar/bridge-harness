...
import { classifyTerminalEscapeIntroducer } from './terminal-escape-introducer.mjs';
const ESC = 0x1b;
const CAN = 0x18;
const SUB = 0x1a;
const BEL = 0x07;
...
function stateAfterEscByte(code) {
...
export function extractPartialEscapeTail(stream) {
    let state = 'ground';
    let start = 0;
...
export function advancePartialEscapeTail(pendingTail, chunk) {
