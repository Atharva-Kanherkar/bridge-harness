...
methods![
    ...
    (VoiceCapabilities, "voice", "voice_capabilities"),
    (VoiceStart, "voice", "voice_start"),
    (VoiceAppend, "voice", "voice_append"),
    (VoiceStop, "voice", "voice_stop"),
    (VoiceCancel, "voice", "voice_cancel"),
    (VoiceLocalStatus, "voice", "voice_local_status"),
    (VoiceLocalSetup, "voice", "voice_local_setup"),
    (VoiceLocalRemove, "voice", "voice_local_remove"),
