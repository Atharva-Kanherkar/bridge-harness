 ...
 * available here" rather than the primary call to action. The word sits
 * beside the mark, so the target is named on the page and not only for
 * assistive technology (WCAG 2.4.4, 2.5.3).
 */
  ...
  return (
    <span className="group relative inline-block">
      ...
      >
        ...
        />
        <span aria-hidden="true" className="absolute inset-0 rounded-xl bg-linear-to-r from-foreground/35 via-foreground/80 to-foreground/35 opacity-40 transition-opacity duration-500 group-hover:opacity-100" />
        <span className="relative z-10 flex h-11 items-center gap-2.5 rounded-xl bg-background px-5 sm:h-12">
          ...
          <span className="text-[15px] font-pixel uppercase tracking-[0.1em]">GitHub</span>
