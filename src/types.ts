...
export interface LearningReport {
  ...
  evaluatedTokens: number; evaluationExecution: "not_run" | "deterministic_only" | "reused_existing_evidence" | "queued" | "executed"; replayPassed: boolean | null; promotionStatus: string;
