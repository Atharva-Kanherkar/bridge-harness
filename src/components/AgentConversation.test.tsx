...
const session: Session = { id: "s", workspaceId: "w", harness: "codex", label: "Codex", status: "working", startedAt: "now", endedAt: null, contextPercent: null, usagePercent: null, metricSource: "reported" };
