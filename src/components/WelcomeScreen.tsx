...
const GitHubLogo = ({ size = 14, fill = "currentColor" }: { size?: number; fill?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden>
...
const CalendarLogo = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden>
    <rect x="2.5" y="3.5" width="19" height="18" rx="3.5" fill="none" stroke="currentColor" strokeWidth="1.7"/>
    <path d="M2.5 8.5h19" stroke="currentColor" strokeWidth="1.7"/>
    <path d="M7 2v3.4M17 2v3.4" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/>
  </svg>
);
