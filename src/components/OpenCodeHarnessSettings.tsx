...
export function OpenCodeHarnessSettings({
  ...
  return <div className="mt-4 space-y-4 border-t border-border/60 pt-4" data-testid="opencode-provider-settings">
    ...
    {discoveryError && <p role="alert" className="rounded-xl border border-destructive/30 bg-destructive/10 px-3 py-2 text-[11px] text-destructive">{discoveryError}</p>}
