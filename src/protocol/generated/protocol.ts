...
export type BridgeMethod =
  ...
  | "voice/voice_stop"
  | "voice/voice_cancel"
  | "voice/voice_local_status"
  | "voice/voice_local_setup"
  | "voice/voice_local_remove"
  ...
  | "terminal/get_terminal_workspace"
  | "terminal/save_terminal_workspace"
  ...
  | "menu_bar/save_menu_bar_settings"
...
export const BRIDGE_METHODS = [
  ...
  { method: "voice/voice_capabilities", domain: "voice", command: "voice_capabilities" },
  { method: "voice/voice_start", domain: "voice", command: "voice_start" },
  { method: "voice/voice_append", domain: "voice", command: "voice_append" },
  { method: "voice/voice_stop", domain: "voice", command: "voice_stop" },
  { method: "voice/voice_cancel", domain: "voice", command: "voice_cancel" },
  { method: "voice/voice_local_status", domain: "voice", command: "voice_local_status" },
  { method: "voice/voice_local_setup", domain: "voice", command: "voice_local_setup" },
  { method: "voice/voice_local_remove", domain: "voice", command: "voice_local_remove" },
  ...
  { method: "terminal/create_terminal", domain: "terminal", command: "create_terminal" },
  { method: "terminal/get_terminal_snapshot", domain: "terminal", command: "get_terminal_snapshot" },
  { method: "terminal/get_terminal_workspace", domain: "terminal", command: "get_terminal_workspace" },
  { method: "terminal/save_terminal_workspace", domain: "terminal", command: "save_terminal_workspace" },
  { method: "terminal/rename_terminal", domain: "terminal", command: "rename_terminal" },
  ...
  { method: "menu_bar/save_menu_bar_settings", domain: "menu_bar", command: "save_menu_bar_settings" },
...
export const BRIDGE_NOTIFICATIONS = [
  ...
  { notification: "terminal-frame", delivery: "transient" },
  { notification: "terminal-exited", delivery: "transient" },
  { notification: "account-usage", delivery: "transient" },
  { notification: "voice-transcript", delivery: "transient" },
...
export interface BridgeMethodParams {
  ...
  "voice/voice_capabilities": VoiceCapabilitiesParams;
  "voice/voice_start": VoiceStartParams;
  "voice/voice_append": VoiceAppendParams;
  "voice/voice_stop": VoiceStopParams;
  "voice/voice_cancel": VoiceCancelParams;
  "voice/voice_local_status": undefined;
  "voice/voice_local_setup": VoiceLocalSetupParams;
  "voice/voice_local_remove": VoiceLocalRemoveParams;
  ...
  "terminal/create_terminal": CreateTerminalParams;
  "terminal/get_terminal_snapshot": GetTerminalSnapshotParams;
  "terminal/get_terminal_workspace": GetTerminalWorkspaceParams;
  "terminal/save_terminal_workspace": SaveTerminalWorkspaceParams;
  "terminal/rename_terminal": RenameTerminalParams;
  ...
  "menu_bar/save_menu_bar_settings": SaveMenuBarSettingsParams;
...
export interface BridgeMethodResults {
  ...
  "voice/voice_capabilities": VoiceCapabilitiesResult;
  "voice/voice_start": VoiceStartResult;
  "voice/voice_append": UnitResult;
  "voice/voice_stop": UnitResult;
  "voice/voice_cancel": UnitResult;
  "voice/voice_local_status": VoiceLocalStatusResult;
  "voice/voice_local_setup": VoiceLocalStatusResult;
  "voice/voice_local_remove": VoiceLocalStatusResult;
  ...
  "terminal/create_terminal": TerminalRecord;
  "terminal/get_terminal_snapshot": TerminalSnapshot;
  "terminal/get_terminal_workspace": TerminalWorkspace;
  "terminal/save_terminal_workspace": UnitResult;
  "terminal/rename_terminal": TerminalRecord;
  ...
  "menu_bar/save_menu_bar_settings": MenuBarSettings;
...
export type MenuBarIconStyle = "bridge" | "meter";

export type MenuBarLayoutToken = "icon" | "provider" | "used" | "remaining" | "weeklyUsed" | "weeklyRemaining" | "fiveHourUsed" | "fiveHourRemaining" | "reset" | "todayCost" | "dot" | "space";

export type MenuBarProvider = "codex" | "claude" | "cursor" | "opencode";

export type MenuBarQuotaDisplayMode = "used" | "remaining";
...
export interface MenuBarSettings {
  ...
  openToOverview?: boolean;
  opencodeEnabled?: boolean;
  opencodeWorkspace?: string | null;
  pinnedProviders?: MenuBarProvider[];
  quotaDisplayMode?: MenuBarQuotaDisplayMode;
  quotaWindow: MenuBarQuotaWindow;
  refreshSeconds: number;
  schemaVersion: number;
  selectedProvider?: MenuBarProvider;
  separateProviderIcons?: boolean;
  showAccount: boolean;
  showCost: boolean;
  showHistory?: boolean;
  showOverviewSummary?: boolean;
  showTokens: boolean;
  statusLayout?: MenuBarLayoutToken[][];
}
...
export type ModelCatalogSource = "runtime_api" | "last_known_good" | "curated_fallback";
...
export interface UsageAccountMetric {
  id: string;
  label: string;
  value: UsageMetric;
}
...
export interface UsageDailyOverview {
  day: string;
  usage: UsagePeriodOverview;
}

export type UsageHistoryOrigin = "local" | "dashboard";
...
export interface UsageMetric {
  source?: UsageMetricSource | null;
  status: UsageMetricStatus;
  value?: number | null;
}

export type UsageMetricSource = "reported" | "measured" | "estimated";

export type UsageMetricStatus = "current" | "stale" | "unavailable";

export interface UsageModelOverview {
  cacheTokens: UsageMetric;
  costMicrousd: UsageMetric;
...
export interface UsageOverviewSnapshot {
  account?: string | null;
  accountMetrics?: UsageAccountMetric[];
  coverage: string;
  daily?: UsageDailyOverview[];
  error?: string | null;
  generatedAt: number;
  month: UsagePeriodOverview;
...
export interface UsagePeriodOverview {
  costMicrousd: UsageMetric;
...
export type VoiceAudioEncoding = "pcm_s16_le";

export type VoiceAvailability = "ready" | "needsSetup" | "unsupported" | "failed";

export type VoiceLocalSetupState = "notInstalled" | "downloadingRuntime" | "downloadingModel" | "installing" | "ready" | "failed" | "unsupported";

export type VoiceProcessingLocation = "onDevice" | "remote";
...
export interface VoiceProviderCapability {
  ...
  processing: VoiceProcessingLocation;
  provider: VoiceProviderId;
  recoveryAction?: VoiceRecoveryAction | null;
  sampleRate: number;
...
export type VoiceProviderId = "local" | "codex";

export type VoiceRecoveryAction = "setup" | "retry";

export type VoiceTranscriptKind = "started" | "delta" | "final" | "error" | "closed" | "partial";
...
export interface CreateChatIdResult {
  sessionId: string;
}
...
export interface VoiceCapabilitiesParams {
  sessionId?: string | null;
}

export interface VoiceCapabilitiesResult {
  providers: VoiceProviderCapability[];
  selectedProvider?: VoiceProviderId | null;
  sessionId?: string | null;
}
...
export interface VoiceAppendParams {
  data: string;
...
export interface VoiceCancelParams {
  voiceSessionId: string;
}

export interface VoiceLocalStatusResult {
  ...
  modelId: string;
  reason?: string | null;
  state: VoiceLocalSetupState;
}

export interface VoiceLocalSetupParams {
  confirmDownload: boolean;
}

export interface VoiceLocalRemoveParams {
...
export interface GetTerminalSnapshotParams {
  terminalId: string;
  workspaceId: string;
}
...
export interface GetTerminalWorkspaceParams {
  workspaceId: string;
}
...
export interface SaveTerminalWorkspaceParams {
  layout: unknown;
  workspaceId: string;
}
