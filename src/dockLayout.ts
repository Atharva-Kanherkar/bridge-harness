...
export type DockPaneId = "changes" | "code" | "terminal" | "browser" | "transcript" | "tasks" | "github";
...
export const DOCK_PANES: readonly DockPaneId[] = ["changes", "code", "terminal", "browser", "transcript", "tasks", "github"];
