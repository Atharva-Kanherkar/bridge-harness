...
| 7 | **Needs-you leaves the rail.** | `view === "work"` stays routable; the rail row, count badge, and `onOpenWorkBoard`/`workNeedsYouCount` props are removed. Reversible via Q4. |
