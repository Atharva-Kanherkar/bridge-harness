...
Design references worth reading before touching those areas: [`docs/session-forest.md`](docs/session-forest.md), [`docs/delegation-policy.md`](docs/delegation-policy.md), [`docs/compaction-and-resume.md`](docs/compaction-and-resume.md), [`docs/managed-agent-runtimes.md`](docs/managed-agent-runtimes.md), [`docs/adaptive-learning.md`](docs/adaptive-learning.md).
